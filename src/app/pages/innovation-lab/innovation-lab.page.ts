...
export class InnovationLabPage implements OnInit {
  research = [
    { badge: 'Flagship Research', status: 'Active', icon: 'bi-lightning-charge', title: 'Smart Energy & Automation Initiative', desc: 'Our core research programme merges renewable energy management with intelligent automation â€” IoT-enabled grid systems and AI-driven control units for Africa\'s smart infrastructure.', tags: ['IoT Systems', 'AI Integration', 'Energy AI', 'Prototyping'] },
